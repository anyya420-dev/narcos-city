...
const L = {
  ru: {
    ...
    hud: { camera: "КАМЕРА", run: "БЕГ", interact: "ВЗАИМОДЕЙСТВИЕ", action: "ДЕЙСТВИЕ", enter: "ВОЙТИ", weather: "ПОГОДА", day: "ДЕНЬ", time: "ВРЕМЯ", daily: "ЕЖЕДН.", rest: "ОТДЫХ", energy: "ЭНЕРГИЯ" },
    prompt: {
    ...
    ui: {
      ...
      housingCosts: "Аренда / Жильё",
      avgSpend: "Ср. расходы",
      notifications: "Уведомления",
      noNotifications: "Уведомлений нет.",
      calendar: "Календарь",
      noCalendar: "Запланированных событий нет.",
      dailyQuests: "Ежедневные задания",
      noDailyQuests: "Ежедневных заданий нет.",
      quests: "Задания",
      ...
      reputationReq: "Требование репутации",
      travelTime: "Время поездки",
      characterName: "Имя персонажа",
      enterName: "Введите имя",
      wantedStatus: "Статус розыска",
      errorTitle: "Временная ошибка интерфейса",
      errorBody: "Интерфейс восстановлен. Вы можете продолжить игру.",
      returnMenu: "Вернуться в меню",
      openSettings: "Открыть настройки",
      resetSave: "Сбросить прогресс",
      ...
      deposit: "Депозит",
      withdraw: "Снятие",
      outfitCasual: "Повседневный",
      outfitElegant: "Элегантный",
      outfitLuxury: "Люкс",
      outfitStreet: "Уличный",
      outfitBusiness: "Деловой",
      outfitNightlife: "Ночной",
      outfitSport: "Спортивный",
      socialInfo: "Социум",
      friends: "друзей",
  ...
  en: {
    ...
    hud: { camera: "CAMERA", run: "RUN", interact: "INTERACT", action: "ACTION", enter: "ENTER", weather: "WEATHER", day: "DAY", time: "TIME", daily: "DAILY", rest: "REST", energy: "ENERGY" },
    prompt: {
    ...
    ui: {
      ...
      calendar: "Calendar",
      noCalendar: "No planned events yet.",
      dailyQuests: "Daily Quests",
      noDailyQuests: "No daily quests.",
      quests: "Quests",
      ...
      reputationReq: "Reputation Req",
      travelTime: "Travel Time",
      characterName: "Character Name",
      enterName: "Enter your name",
      wantedStatus: "Wanted Status",
      errorTitle: "Temporary UI Error",
      errorBody: "The interface recovered safely. Use the actions below to continue playing.",
      ...
      withdraw: "Withdraw",
      outfitCasual: "Casual",
      outfitElegant: "Elegant",
      outfitLuxury: "Luxury",
      outfitStreet: "Street",
      outfitBusiness: "Business",
      outfitNightlife: "Nightlife",
      outfitSport: "Sport",
      socialInfo: "Social",
      friends: "friends",
      followers: "followers",
